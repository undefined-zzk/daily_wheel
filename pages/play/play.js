...
Page({
  ...
  addItem() {
    ...
    const result = storageUtil.addItem('play', item)
    if (result.success) {
      this.setData({
        list: storageUtil.getList('play'),
        newItem: ''
  ...
  saveEdit() {
    ...
    if (storageUtil.updateItem('play', this.data.editIndex, value)) {
      this.setData({
        list: storageUtil.getList('play'),
        editIndex: -1,
        editValue: ''
  ...
  confirmDelete(index) {
    if (storageUtil.deleteItem('play', index)) {
      this.setData({
        list: storageUtil.getList('play')
      })
  ...
  confirmReset() {
    if (storageUtil.resetToDefault('play')) {
      this.setData({
        list: storageUtil.getList('play')
      })
